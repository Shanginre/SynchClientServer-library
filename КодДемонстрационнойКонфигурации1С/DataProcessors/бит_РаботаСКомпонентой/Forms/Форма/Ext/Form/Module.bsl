...
&НаКлиенте
Процедура ЗапуститьКомпонентуВРежимеОтладки(Команда)
	ЗапуститьКомпонентуВРежимеОтладкиНаСервере();
КонецПроцедуры

&НаСервере
Процедура ЗапуститьКомпонентуВРежимеОтладкиНаСервере()
	бит_КомпонентаSynchClientServerКлиентСервер.ЗапуститьСервер();	
КонецПроцедуры
